        ...
        <div className="hidden md:flex items-center space-x-4">
          {isAuthenticated && user ? (
            <>
              ...
              <Link to="/vivo" className="hover:text-gray-300 px-2 py-1 rounded hover:bg-gray-700 transition-colors">Vivo</Link>
          ...
          <div className="flex flex-col space-y-1">
            {isAuthenticated ? (
              <>
                ...
                <Link to="/vivo" onClick={closeMenu} className="px-2 py-2 rounded hover:bg-gray-700 transition-colors">Vivo</Link>
                <button
                  onClick={handleLogout}
